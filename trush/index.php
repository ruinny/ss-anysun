...
<head>
  ...
  <link rel="icon" href="image\collection_fill.png"> </head>

<body>
  <div class="py-5 text-center opaque-overlay" style="background-image: url(http://ojnt3z55e.bkt.clouddn.com/anysun/image/64800561_p0.jpg);">
    <div class="container py-5">
      <div class="row">
        <div class="col-md-12 text-white">
          <h1 class="display-3 mb-4">Rui的节点分享</h1>
          <p class="lead mb-5">欢迎访问，这里提供一个免费、简洁、开放的SSR和V2ray节点分享。</p>
        </div>
      </div>
    </div>
  </div>
          ...
          <table class="table">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>37500</td>
                    <td>367086ec-13ea-4fb4-971c-0a517521c128</td>
                    <td>233</td>
                    <td>ws</td>
                    <td></td>
                    <td>Virmach-Sanjose节点</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>43298</td>
                    <td>a407ef12-9dde-46bc-b07f-c0c00d9ccaf3</td>
                    <td>233</td>
                    <td>tcp</td>
                    <td></td>
                    <td>DO-SPG节点</td>
  ...
  <div class="row-fluid">
    <div class="span12">
       <button class="btn btn-primary btn-block" type="button" href="http://status.anysun.win:81/#">服务器状态查询</button>
    </div>
  </div>
</div>
  ...
  <div class="">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <p class="lead">PC端</p>
          <p class="">推荐使用Breakwa11的SSR，高级教程请百度自查。</p>
